...
- ⚙️ I use daily: `.dart`, `.js`, `.html`, `.css`, `.py`, `.ts`, `.tsx` (and you can list down more)
- 🌍 I'm mostly active within the `Flutter Community`
- 🤖 Gemini API Google Solution Challenge APAC 2025 - `Participant`
- 💅 Designed: [Campus Hub](https://campushub.my), [Pengembara Nomad](https://www.pengembaranomad.com.my), etc.
- 💬 `ping` me at `haqimhaslee@qimlab.my` about **UI/UX**, **Sofware Dev**, **App Dev**, **Web Dev**, **Cloud**, **AI/ML**, **Database**
- 🍽 Oh you can chat with me about best food recipe too
